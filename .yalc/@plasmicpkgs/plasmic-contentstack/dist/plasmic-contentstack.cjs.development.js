  ...
  props: {
    ...
    filterField: {
      ...
      hidden: function hidden(props, ctx) {
        return !props.contentType || !props.limit;
      }
    },
    queryOperator: {
      type: "choice",
...
function ContentStackFetcher(_ref2) {
  ...
  var _usePlasmicQueryData = query.usePlasmicQueryData(contentType && limit ? cacheKey + "/" + contentType + "/entries" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
    var resp;
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("https://cdn.contentstack.io/v3/content_types/" + contentType + "/entries?environment=" + creds.environment + "&limit=" + limit, {
              headers: {
                api_key: creds.apiKey,
                access_token: creds.accessToken
              }
  ...
  var _usePlasmicQueryData2 = query.usePlasmicQueryData(contentType && filterField && filterValue && limit ? cacheKey + "/" + contentType + "/filtered" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
    var url, resp;
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            if (!queryOperator) {
              url = "https://cdn.contentstack.io/v3/content_types/" + contentType + "/entries?environment=" + creds.environment + "&query={\"" + filterField + "\": \"" + filterValue + "\"}&limit=" + limit;
            } else {
              url = "https://cdn.contentstack.io/v3/content_types/" + contentType + "/entries?environment=" + creds.environment + "&query={\"" + filterField + "\":{\"" + queryOperator + "\" :\"" + filterValue + "\"}}&limit=" + limit;
            }
  ...
  if (!entriesData) {
    return React__default.createElement("div", null, "Please specify content type and and limit ");
  }
...
//# sourceMappingURL=plasmic-contentstack.cjs.development.js.map
