...
function ContentStackFetcher(_ref2) {
  ...
  var _usePlasmicQueryData = usePlasmicQueryData(contentType && limit ? cacheKey + "/" + contentType + "/entries" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
    var resp;
  ...
  var _usePlasmicQueryData2 = usePlasmicQueryData(contentType && filterField && filterValue && limit ? cacheKey + "/" + contentType + "/filtered" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
    var url, resp;
  ...
  if (!entriesData) {
    return React.createElement("div", null, "Please specify content type and and limit ");
  }
...
//# sourceMappingURL=plasmic-contentstack.esm.js.map
