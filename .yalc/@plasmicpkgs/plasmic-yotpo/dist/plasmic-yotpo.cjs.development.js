...
function YotpoReviews(_ref2) {
  ...
  if (!reviewsData) {
    return React__default.createElement("div", null, "Please configure the Yotpo Credentials provider with valid AppKey.");
  }
  ...
  if (!creds.uToken || !creds.appKey) {
    return React__default.createElement("div", null, "Please specify a valid API Credentials: uToken,appKey");
  }

  if (!reviewData) {
    return React__default.createElement("div", null, "Please choose the reviewId");
  }

  if (!productPrice || !currency) {
    return React__default.createElement("div", null, " Please enter Product price and Currency");
  }
...
exports.YotpoCredentialsProvider = YotpoCredentialsProvider;
exports.YotpoCredentialsProviderMeta = YotpoCredentialsProviderMeta;
exports.YotpoReviews = YotpoReviews;
exports.YotpoReviewsMeta = YotpoReviewsMeta;
exports.YotpoStarRating = YotpoStarRating;
exports.YotpoStarRatingMeta = YotpoStarRatingMeta;
exports.ensure = ensure;
exports.registerAll = registerAll;
//# sourceMappingURL=plasmic-yotpo.cjs.development.js.map
