  ...
  props: {
    ...
    filterField: {
      ...
      hidden: function hidden(props, ctx) {
        return props.contentType == undefined || props.limit == undefined;
      }
    },
    searchOperator: {
      type: "choice",
      displayName: "Query Operator",
      description: "Search Operator filter by.Read more (https://www.contentful.com/developers/docs/references/content-delivery-api/#/reference/search-parameters/)",
      options: function options(props, ctx) {
        return searchOperators.map(function (item) {
          return {
...
function ContentfulFetcher(_ref2) {
  var _contentTypes$items, _contentTypes$items2;

  var filterField = _ref2.filterField,
      filterValue = _ref2.filterValue,
      searchOperator = _ref2.searchOperator,
  ...
  var url = "https://cdn.contentful.com";
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(url + "/spaces/" + creds.space + "/environments/" + creds.environment + "/content_types?access_token=" + creds.accessToken);
  ...
  var _usePlasmicQueryData2 = query.usePlasmicQueryData(contentType && limit ? cacheKey + "/" + contentType + "/entriesData" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
    var query, resp;
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (order) {
              query = "/spaces/" + creds.space + "/environments/" + creds.environment + "/entries?access_token=" + creds.accessToken + "&content_type=" + contentType + "&order=" + order + "&limit=" + limit;
            } else {
              query = "/spaces/" + creds.space + "/environments/" + creds.environment + "/entries?access_token=" + creds.accessToken + "&content_type=" + contentType + "&limit=" + limit;
            }
    ...
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            queryPath = "/spaces/" + creds.space + "/environments/" + creds.environment + "/entries?access_token=" + creds.accessToken + "&content_type=" + contentType + "&fields." + filterField + searchOperator + "=" + filterValue + "&limit=" + limit;
            _context3.next = 3;
            return fetch("" + url + queryPath);
  ...
  if (!contentType && !limit) {
    return React__default.createElement("div", null, "Please select a content type and specify the limit");
  }

  if (contentType && !limit) {
    return React__default.createElement("div", null, " Please specify the limit");
  }

  if (!entriesData) {
    return React__default.createElement("div", null, "Please select a content type and and enter the limit");
  }
  ...
  if (searchOperator && !filterValue && !filterField) {
    return React__default.createElement("div", null, "Please specify a Filter Field and a Filter Value");
  }

  if (!searchOperator && filterValue && !filterField) {
    return React__default.createElement("div", null, "Please specify a Search Operator and a Filter Field");
  }

  if (!searchOperator && !filterValue && filterField) {
    return React__default.createElement("div", null, "Please specify a Search Operator and a Filter Value");
  }
  ...
  if (!searchOperator && filterValue && filterField) {
    return React__default.createElement("div", null, "Please specify a Search Operator");
  }
  ...
  if (filteredData) {
    ...
    renderedData = filteredData == null ? void 0 : (_filteredData$items2 = filteredData.items) == null ? void 0 : _filteredData$items2.map(function (item, index) {
      var _item$sys;
  ...
  }, noAutoRepeat ? children : noLayout ? React__default.createElement(React__default.Fragment, null, " ", renderedData, " ") : React__default.createElement("div", {
    className: className
  }, " ", renderedData, " "));
}
