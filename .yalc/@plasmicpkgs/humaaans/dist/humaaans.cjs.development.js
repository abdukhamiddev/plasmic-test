...
var Human = function Human(_ref) {
  ...
  var Head = React.lazy(function () {
    return new Promise(function (resolve) { resolve(_interopNamespace(require("" + ASSET_ROOT_DIRECTORY + HEAD_DIRECTORY_SUFFIX + head))); });
  });
  var Torso = React.lazy(function () {
    return new Promise(function (resolve) { resolve(_interopNamespace(require("" + ASSET_ROOT_DIRECTORY + TORSO_DIRECTORY_SUFFIX + torso))); });
  });
  var Bottom = React.lazy(function () {
    return new Promise(function (resolve) { resolve(_interopNamespace(require("" + setBottomDirectory(posture) + bottom))); });
  });
...
exports.Humaaans = Humaaans;
exports.HumaaansMeta = HumaaansMeta;
exports.registerAll = registerAll;
//# sourceMappingURL=humaaans.cjs.development.js.map
