  ...
  props: {
    ...
    queryOperator: {
      ...
      hidden: function hidden(props, ctx) {
        return !props.queryType || !props.limit;
      }
    },
    filterValue: {
      type: "string",
...
function WordpressFetcher(_ref2) {
  ...
  var _usePlasmicQueryData = usePlasmicQueryData(queryType === "posts" ? cacheKey + "/posts" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(creds.wordpressUrl + "/wp-json/wp/v2/posts?per_page=" + limit);
  ...
  var _usePlasmicQueryData2 = usePlasmicQueryData(queryType === "pages" ? cacheKey + "/pages" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch(creds.wordpressUrl + "/wp-json/wp/v2/pages&per_page=" + limit);
  ...
  var _usePlasmicQueryData3 = usePlasmicQueryData(queryType === "pages" && queryOperator && filterValue ? cacheKey + "/pages/filtered" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3() {
    return runtime_1.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return fetch(creds.wordpressUrl + "/wp-json/wp/v2/pages?" + queryOperator + "=" + filterValue + "&per_page=" + limit);
  ...
  var _usePlasmicQueryData4 = usePlasmicQueryData(queryType === "posts" && queryOperator && filterValue ? cacheKey + "/posts/filtered" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4() {
    return runtime_1.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return fetch(creds.wordpressUrl + "/wp-json/wp/v2/posts?" + queryOperator + "=" + filterValue + "&per_page=" + limit);
  ...
  if (queryOperator && !filterValue) {
    return React.createElement("div", null, "Please specify Filter Value");
  }

  if (!queryOperator && filterValue) {
    return React.createElement("div", null, "Please specify Query Operator");
  }
  ...
  if (queryType === "posts" && posts && !filteredPosts) {
    ...
    if (!filteredPages && queryOperator === "pages") {
      return React.createElement("div", null, "Please make sure queryType is pages");
    }

    if (filteredPages.length === 0) {
      return React.createElement("div", null, "No published pages found");
    }

    renderedData = filteredPages == null ? void 0 : filteredPages.map(function (page, i) {
      return React.createElement(DataProvider, {
        key: page.id,
        name: "wordpressItem",
        data: page,
    ...
    if (!filteredPosts && queryOperator === "posts") {
      return React.createElement("div", null, "Please make sure queryType is posts");
    }

    if (filteredPosts.length === 0) {
      return React.createElement("div", null, "No published posts found");
    }
    ...
    return React.createElement("div", null, "Please choose the Query Type in order to render the data");
  }
...
function WordpressField(_ref7) {
  ...
  var item = useSelector("wordpressItem");
...
//# sourceMappingURL=plasmic-wordpress.esm.js.map
