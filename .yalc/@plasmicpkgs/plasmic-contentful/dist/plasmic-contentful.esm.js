...
function ContentfulFetcher(_ref2) {
  ...
  var _usePlasmicQueryData2 = usePlasmicQueryData(contentType && limit ? cacheKey + "/" + contentType + "/entriesData" : null, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
    var query, resp;
  ...
  if (!contentType && !limit) {
    return React.createElement("div", null, "Please select a content type and specify the limit");
  }

  if (contentType && !limit) {
    return React.createElement("div", null, " Please specify the limit");
  }

  if (!entriesData) {
    return React.createElement("div", null, "Please select a content type and and enter the limit");
  }
  ...
  if (!searchOperator && filterValue && !filterField) {
    return React.createElement("div", null, "Please specify a Search Operator and a Filter Field");
  }

  if (!searchOperator && !filterValue && filterField) {
    return React.createElement("div", null, "Please specify a Search Operator and a Filter Value");
  }
  ...
  if (!searchOperator && filterValue && filterField) {
    return React.createElement("div", null, "Please specify a Search Operator");
  }
  ...
  }, noAutoRepeat ? children : noLayout ? React.createElement(React.Fragment, null, " ", renderedData, " ") : React.createElement("div", {
    className: className
  }, " ", renderedData, " "));
}
